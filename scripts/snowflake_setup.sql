...
CREATE OR REPLACE NETWORK RULE SNOWFLAKE_LEARNING_DB.PUBLIC.geocoding_network_rule
  MODE = EGRESS
  TYPE = HOST_PORT
  VALUE_LIST = ('nominatim.openstreetmap.org');
...
CREATE OR REPLACE EXTERNAL ACCESS INTEGRATION DATA_CHALLENGE_EXTERNAL_ACCESS
  ALLOWED_NETWORK_RULES = (
    ...
    SNOWFLAKE_LEARNING_DB.PUBLIC.geocoding_network_rule
  )
  ENABLED = TRUE;
